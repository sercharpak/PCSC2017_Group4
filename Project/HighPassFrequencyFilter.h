 ...
 */
//=======================================================================
#ifndef PROJECT_HIGHPASSFREQUENCYFILTER_H
#define PROJECT_HIGHPASSFREQUENCYFILTER_H
/** Class which defines a high pass filter in the fourier domain.
 * Applies a HighPass Frequency. All the frequencies less than the frequency given are set to 0.
 */
#include "FrequencyFilter.h"
class HighPassFrequencyFilter : public FrequencyFilter{
public:
     ...
     */
    HighPassFrequencyFilter(double pFrecuency);
    /** Applies the filter to the frequency data of a signal
     * Applies a HighPass Frequency. All the fourier data less than the frequency given are set to 0.
...
#endif //PROJECT_HIGHPASSFREQUENCYFILTER_H
